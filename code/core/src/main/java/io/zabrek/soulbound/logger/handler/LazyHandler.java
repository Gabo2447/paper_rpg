...
public class LazyHandler extends Handler {
     ...
     *
     * @param log            the {@link SoulBoundLogger} to use for logging initialization errors
     * @param handlerFactory the {@link Supplier} to use for creation
     */
    public LazyHandler(final SoulBoundLogger log, final LazyHandlerSupplier handlerFactory) {
        super();
        this.log = log;
