...
public interface SoulBoundLogger {
     ...
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#debug(String, Throwable)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#debug(LogSource, String)} instead.
     *
     ...
     * Use this for additional debug log information.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#debug(String)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#debug(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     ...
     * Use this for additional debug log information.
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#debug(LogSource, String, Throwable)} instead.
     *
     ...
     * Use this for additional debug log information.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#debug(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
     ...
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#info(LogSource, String)} instead.
     *
     * @param msg The message to log.
     * @since 2.0.0
     */
     ...
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#warn(String, Throwable)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#warn(LogSource, String)} instead.
     *
     * @param msg The message to log.
     * @since 2.0.0
     */
     ...
     * Use this if you can provide useful information how to fix the underlying problem.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#warn(String)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#warn(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     * @param thrown The throwable to log.
     * @since 2.0.0
     ...
     * Use this if you can provide useful information how to fix the underlying problem.
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#warn(LogSource, String, Throwable)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @since 2.0.0
     ...
     * Use this if you can provide useful information how to fix the underlying problem.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#warn(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
     ...
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#error(String, Throwable)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#error(LogSource, String)} instead.
     *
     * @param msg The message to log.
     * @since 2.0.0
     */
     ...
     * Usage is also allowed if you don't know how the user can fix the underlying issue.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#error(String)} instead.
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#error(LogSource, String, Throwable)} instead.
     *
     * @param msg    The message to log.
     * @param thrown The throwable to log.
     * @since 2.0.0
     ...
     * Usage is also allowed if you don't know how the user can fix the underlying issue.
     * <p>
     * If you can provide an exception use {@link SoulBoundLogger#error(LogSource, String, Throwable)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @since 2.0.0
     ...
     * Usage is also allowed if you don't know how the user can fix the underlying issue.
     * <p>
     * If you cannot provide an exception use {@link SoulBoundLogger#error(LogSource, String)} instead.
     *
     * @param logSource The related {@link LogSource}.
     * @param msg       The message to log.
     * @param thrown    The throwable to log.
     ...
     * <p>
     * Don't use this method, if you can provide a {@link LogSource}.
     * Use {@link SoulBoundLogger#reportException(LogSource, Throwable)} instead.
     *
     * @param thrown The throwable to log.
     * @since 2.0.0
     */
