package io.zabrek.soulbound.api.version;
...
public interface Version extends Comparable<Version> {
     ...
     * <p>
     * For example, version "1.2.3" and "1.0.0" may be compatible with "1.0.0" when using a standard semantic
     * version comparator, but version "0.9.5" is not compatible with "1.0.0" in the same way.
     *
