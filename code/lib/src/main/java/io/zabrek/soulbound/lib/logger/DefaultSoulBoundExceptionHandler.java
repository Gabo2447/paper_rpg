...
public class DefaultSoulBoundExceptionHandler implements SoulBoundExceptionHandler {
    ...
    /**
     * Creates a new {@link DefaultSoulBoundExceptionHandler} instance with an error rate limit
     * of DEFAULT_ERROR_RATE_LIMIT_MILLIS.
     *
     * @param source        the source to use for logging
     * @param logger        the logger to use
     * @param sourceDetails additional source details to log
    ...
    private void handleException(final SoulBoundException exception) {
