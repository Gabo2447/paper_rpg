...
public class DefaultEventListenerGroup<T extends Event> implements EventListenerGroup<T> {
     ...
     */
    public DefaultEventListenerGroup(final SoulBoundLogger logger, final Class<T> eventClass) {
    ...
    @Override
    public void bake(final Plugin plugin) throws SoulBoundException {
    ...
    @Override
    public void callEvent(final T event, final EventPriority priority) throws SoulBoundException {
    ...
    @Override
    public ProxyListener<T> createListener(final Plugin plugin, final Class<T> eventClass, final EventPriority priority) throws SoulBoundException {
        final SoulBoundExceptionHandler handler = new DefaultSoulBoundExceptionHandler(LogSource.EMPTY, log, eventClass.getSimpleName(), priority.name());
