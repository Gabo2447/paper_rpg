...
import io.zabrek.soulbound.lib.version.DefaultVersionType;
import io.zabrek.soulbound.lib.version.VersionComparisonStrategies;
import io.zabrek.soulbound.lib.version.VersionParser;
...
/**
 * Patches SoulBound's configuration file.
 */
public class Patcher {
     ...
     */
    public Patcher(final SoulBoundLogger log, final ConfigAccessor resourceAccessor, final PatchTransformerRegistry transformerRegistry, final ConfigurationSection patchConfig) throws InvalidConfigurationException {
        this.log = log;
