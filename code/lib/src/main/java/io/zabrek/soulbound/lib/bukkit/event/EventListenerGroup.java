...
public interface EventListenerGroup<T extends Event> {
     ...
     * @throws SoulBoundException if an error occurs while instantiating the listeners
     */
    void bake(Plugin plugin) throws SoulBoundException;
     ...
     * @throws SoulBoundException if an error occurs while calling the event
     */
    void callEvent(T event, EventPriority priority) throws SoulBoundException;
